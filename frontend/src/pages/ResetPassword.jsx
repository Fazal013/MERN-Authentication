...
function ResetPassword() {
  ...
  return (
    ...
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-b from-blue-300 to-purple-500'>
      ...
      {!isEmailSent && 
      <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
       <h1 className='text-white text-2xl font-semibold text-center mb-4'>Reset Password</h1>
        < p className='text-center mb-6 text-indigo-300'>Enter your registered Mail Id</p>
        <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
          <img src={assets.mail_icon} alt="" className='w-3 h-3'/>
          <input type="email" placeholder='Email Id' className='bg-transparent outline-none' 
    ...
    <form onSubmit={onSubmitOtp} className='bg-slate-900 p-8 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
      ...
      <form onSubmit={onSubmitNewPassowrd} className='bg-slate-900 p-8 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
